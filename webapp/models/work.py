...
class Work(models.Model):
    ...
    edition_yn = models.CharField(max_length=2, choice=YES_NO_CHOICES, null=True) # 에디션 여부
    ...
    frame_yn = models.CharField(max_length=2, choices=YES_NO_CHOICES, null=True) # 액자 여부
    ...
    guarantee_yn = models.CharField(max_length=2, choices=YES_NO_CHOICES, null=True) # 보증서 유무
...
class WorkSize(models.Model):
    work_id = models.ForeignKey(Work, primary_key=True, on_delete=models.PROTECT, null=False) # 작품 번호
    ...
    canvas_yn = models.CharField(max_length=2, choices=YES_NO_CHOICES, null=True) # 캔버스 여부
    ...
    canvas_ext_yn = models.CharField(max_length=2, choices=YES_NO_CHOICES, null=True) # 캔버스 EXT 여부