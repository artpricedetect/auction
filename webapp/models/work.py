...
class Work(models.Model):
    ...
    edition_num = models.CharField(max_length=255, null=True)  # 에디션 넘버(스트링)
    ...
    frame_yn = models.CharField(max_length=255, null=True)  # 액자 여부
    sign_yn = models.BooleanField(null=True)  # 싸인 여부
    status = models.CharField(max_length=255, null=True)  # 상태
    guarantee_yn = models.CharField(max_length=255, null=True)  # 보증서 유무
